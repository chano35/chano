...
<body>
    ...
    %>                  	
     ...
     <div class="container">
          <div class="row">
              <form method="post" action="eventUpdateAction.jsp?bbsID=<%= bbsID %>">
                <table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
                   ...
                   <tbody>
                        <tr>
                            <td><input type="text" class="form-control" placeholder="글 제목" name="bbsTitle" maxlength="50" value="<%= bbs.getE_title() %>"></td> <!-- 자기가 썼던 제목이 보여짐 -->
                        </tr>                                                      
                        <tr>
                            <td><textarea class="form-control" placeholder="글 내용" name="bbsContent" maxlength="2048" style="height: 350px;"> <%= bbs.getE_text() %></textarea></td> 
                        </tr>
                   </tbody>                  
                </table>
              <%    
