    ...
    %>                  	
     ...
     <div class="container">
          <div class="row">
                <table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
                   ...
                   <tbody>
                        <tr>
                            ...
                            <td colspan="2"><%= bbs.getN_title().replaceAll(" ", "&nbsp;").replaceAll("<", "&lt;").replaceAll(">", "&gt;").replaceAll("\n", "<br>") %></td> <!-- bbs.jsp는 게시글 클릭 전, view.jsp는 게시글 클릭 후 -->
                        </tr>
                         <tr>
                            <td>작성자</td>
                            <td colspan="2">관리자</td>
                        ...
                        <tr>
                            <td>작성일자</td>
                            <td colspan="2"><%= bbs.getN_date().substring(0, 11) + bbs.getN_date().substring(11, 13) + "시" + bbs.getN_date().substring(14, 16) + "분" %></td>
                        </tr> 
                        <tr>
                            <td>내용</td>
                            <td colspan="2" style="min-height: 200px; text-align: left;"><%= bbs.getN_text().replaceAll(" ", "&nbsp;").replaceAll("<", "&lt;").replaceAll(">", "&gt;").replaceAll("\n", "<br>") %></td>
                        </tr>                                                                              
                   </tbody>                  
                </table>
              ...
              %> 
                        <a href="noticeUpdate.jsp?bbsID=<%= bbsID %>" class="btn btn-primary">수정</a>  
                        <a onclick="return confirm('정말로 삭제하시겠습니까?')" href="noticeDeleteAction.jsp?bbsID=<%= bbsID %>" class="btn btn-primary">삭제</a>
              <% 
                 }
                    } catch (Exception e) {
                      e.printStackTrace();
